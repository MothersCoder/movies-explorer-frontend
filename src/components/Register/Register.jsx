      ...
      <section className="register">
        ...
        <form className="register__form" onSubmit={handleRegisterClick}>
          ...
          <input
            ...
            required
          />
          <span className="register__err">
            {!formInputs.isValid ? formInputs.errors.name : ""}
          </span>
          ...
          <input
            ...
            onChange={formInputs.handleChange}
            placeholder="Введите ваше электронный адрес"
            name="email"
            required
          />
          <span className="register__err">
            {!formInputs.isValid ? formInputs.errors.email : ""}
          </span>

          <label className="register__label">Пароль</label>
          <input
            className={`register__input ${
              props.error ? 'register__input_err' : ""
            }`}
            type="password"
          ...
          <button
            className={`register__button ${
              !formInputs.isValid ? "register__button_disabled" : ""
            }`}
            type="submit"
        ...
        <p className="register__assumption">
